                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFieldCustom(
                          controller: controller.oldPasswordEditingController,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            TextCustom(
                              'Quên mật khẩu?',
                              style: TextStyle(
                                  color: Colors.black, fontSize: Utils.width(15),fontWeight: FontWeight.bold),
                              callBack: (text){
                      ...
                      Container(
                        ...
                        child: TextFieldCustom(
                          ...
                          // prefixIcon: const Icon(Icons.search,color: Colors.black,),
                          textAlignVertical: TextAlignVertical.top,
                          hintText: "Nhập mật khẩu mới xác nhận",
                          isSecureText: true,
                          hintTextStyle: const TextStyle(
                              color: Colors.blueGrey,
                              fontWeight: FontWeight.w500),
